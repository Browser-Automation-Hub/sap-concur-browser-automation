/**
 * basic-login.js — Basic login example for SAP Concur
...
async function main() {
  ...
  try {
    log('Starting SAP Concur automation (Open Source mode)');
    ...
    const result = await login_concur(page, {
    ...
    // const data = await submit_expense_report(page, {});
    // log('Data:', data);
